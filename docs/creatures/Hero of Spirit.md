...
statblock: inline
---
 #monster #miniboss [[08. The Eighth Heroine Dungeon]] [[Phantom Heroes]]
...
traits:
  ...
  - name: Hero's Aura.
    desc: "At the start of each of the hero's turns, each creature within 5 feet of it takes 7 (2d6) thunder damage. A creature that touches the hero or hits it with a melee attack while within 5 feet of it takes 7 (2d6) thunder damage."
actions:
