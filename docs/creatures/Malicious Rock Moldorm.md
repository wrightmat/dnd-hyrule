...
traits:
  ...
  - name: Weak Point.
    desc: "Attacks which specifically target the tip of the moldorm’s tail bypass its damage immunity. Any attack roll made as a called shot, such as against this weak point, is made with disadvantage."
  - name: Wounded Fury.
    desc: "While it has 20 hit points or fewer, the moldorm has advantage on attack rolls."
actions:
  - name: Multiattack.
    desc: "The moldorm makes one bite attack and one slam attack."
  - name: Bite.
...
* https://www.dandwiki.com/wiki/Great_Moldorm_(5e_Creature)