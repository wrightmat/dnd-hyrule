...
statblock: inline
---
 #monster #boss [[04. Reflecting Pool Dungeon]]

```statblock
image: [[Wikilink To Image]]
name: Malicious Water Elemental
size: Large
type: Elemental
...
damage_resistances: acid; bludgeoning, piercing, and slashing damage from nonmagical weapons
