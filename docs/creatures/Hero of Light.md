...
statblock: inline
---
 #monster #miniboss [[08. Shrine of the Seven Dungeon]] [[Phantom Heroes]]
...
traits:
  ...
  - name: Hero's Aura.
    desc: "At the start of each of the hero's turns, each creature within 5 feet of it takes 7 (2d6) radiant damage. A creature that touches the hero or hits it with a melee attack while within 5 feet of it takes 7 (2d6) radiant damage."
actions:
