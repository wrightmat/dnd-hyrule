...
statblock: inline
---
 #monster #miniboss [[07. Thundra Plateau Dungeon]] [[Phantom Heroes]]

```statblock
layout: Party Scaled 5e Layout
party-level: 8
image: 
name: Hero of Lightning
size: Medium
type: Humanoid
...
traits:
  ...
  - name: Hero's Aura.
    desc: "At the start of each of the hero's turns, each creature within 5 feet of it takes 7 (2d6) lightning damage. A creature that touches the hero or hits it with a melee attack while within 5 feet of it takes 7 (2d6) lightning damage."
actions:
