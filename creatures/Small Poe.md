...
size: Small
type: Undead
alignment: chaotic evil (50%) or chaotic neutral (50%)
ac: 11
hp: 55
hit_dice: 10d6 + 20
speed: 10 ft., fly 30 ft. (hover)
stats: [11, 17, 15, 8, 12, 16]
skillsaves:
  - stealth: 3
damage_resistances: acid, fire, cold, lightning
...
actions:
  - name: Lantern Attack.
    desc: "Melee Weapon Attack: +2 to hit, reach 5 ft., one target. Hit: 6 (2d6) bludgeoning damage plus 3 (1d6) fire damage and if the target is a creature or flammable object, it ignites. Until a creature takes an action to douse the fire, the target takes 3 (1d6) fire damage at the start of each of its turns."
  - name: Ghastly Touch.
    desc: "Melee Spell Attack: +5 to hit, reach 5 ft., one creature. Hit: 10 (2d6 + 3) necrotic damage."
  - name: Magic Drain.
